...
<div class="wrapper">
  <header class="main-header">
    <a href="" class="logo js-reload-page">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li><a href="<?=$displayUrl?>" target="_blank" rel="noopener noreferrer"><i class="fa fa-desktop"></i> <span>Buka Display</span></a></li>
		...
		<li><a data-target="ppt"><i class="fa fa-file-powerpoint-o"></i> <span>Embed PPT</span></a></li>
		<li><a data-target="wallpaper"><i class="fa fa-image"></i> <span>Wallpaper</span></a></li>
